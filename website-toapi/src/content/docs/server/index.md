...
- [`createLocalFetch`](/tapi/server/reference/create-local-fetch/) — a local `fetch` for `createFetchClient` that calls your handlers in-process without an HTTP round-trip.
