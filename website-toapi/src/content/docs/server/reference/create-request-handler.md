...
- [`defineApi`](/server/reference/define-api/) — build the API definition passed in here.
- [`createLocalClient`](/server/reference/create-local-client/) — wraps `createRequestHandler` to call handlers in-process.
- [Caching Strategies](/server/reference/caching/) — how the cache layers cooperate.
